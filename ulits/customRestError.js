...
export const editorAndAuthorNotSame = (authorId, manipulator) => {
    if (authorId.toString() !== manipulator.toString()) {
        throw new ApiError(403, "Unauthorized! You are not permitted to edit or delete the blog ")
    }
}

// this will be find a data in collection by it id and if not fount return null. If found then return it. 
